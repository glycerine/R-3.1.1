...
R_PKGS_RECOMMENDED =  MASS lattice Matrix nlme survival boot cluster codetools foreign KernSmooth rpart class nnet spatial mgcv Rserve bitops Rcpp RCurl RProtoBuf httpuv caTools RJSONIO xtable digest htmltools shiny rzmq plyr rmongodb jsonlite rredis bit ff ffbase biglm DBI RMySQL iterators knitr evaluate zoo mime testthat formatR markdown stringr highr fastmatch rmarkdown yaml devtools httr memoise  rstudioapi whisker colorspace dichromat ggplot2 gtable labeling munsell proto RColorBrewer reshape2 scales  rJava RJDBC RCassandra
