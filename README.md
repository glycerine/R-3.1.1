...
apt-get install libx11-dev libxt-dev libcairo2-dev gcc g++ make gfortran libreadline6-dev curl libcurl3 libcurl4-gnutls-dev mysql-common libmysqlclient-dev mysql-client-core-5.5
